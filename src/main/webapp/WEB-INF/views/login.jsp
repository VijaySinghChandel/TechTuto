					...
					<div class="modal-body" style="padding: 40px 50px;">
						<form action="${loginUrl}" method="post" class="form-horizontal">
							...
							<c:if test="${userId != null}">
								<div class="alert alert-success">
									<p>Welcome ! ${userId} your registration is Successfully.</p>
									<p>Please Login with your User Id : ${userId}</p>
								</div>
							</c:if>
							<c:if test="${userEmail != null}">
								<div class="alert alert-success">
									<p>Sorry User Email ${userEmail}, Already Exists, Please click to reset the Password</p>
								</div>
							</c:if>
							...
							<div class="input-group c">
								Not a member? <a href="/TechTuto/signUp">Sign Up</a>
							</div>
							<div class="input-group c">
