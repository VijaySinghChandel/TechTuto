		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a class="page-scroll" href="/TechTuto/signUp">Sign
							Up</a></li>
					<!-- 					<li><a class="page-scroll" data-toggle="modal" data-target=".bs-example-modal-sm">Login</a></li> -->
					<li><a class="page-scroll" href="/TechTuto/user">Login</a></li>
		<!-- 			<li><a class="page-scroll" href="/TechTuto/admin">Admin
							Login</a></li>
					<li><a class="page-scroll" href="/TechTuto/db">DBA
							Login</a></li> -->
		...
		<div class="container" style="padding: 25px 30px;" align="left">
			<div class="login-form">
				...
				<div class="modal-body" style="padding: 40px 50px;">
					<form:form modelAttribute="user" action="/TechTuto/addUser" method="POST" class="form-horizontal">
						<div class="input-group c">
							<label for="email"><span
								class="col-sm-2 glyphicon glyphicon-user"></span> User ID</label> <input
								type="text" class="form-control" id="userId" name="userId"
								placeholder="Enter User ID" required>
						</div>
						<div class="input-group c">
							<label for="email"><span
								class="col-sm-2 glyphicon glyphicon-user"></span> First Name</label> <input
								type="text" class="form-control" id="firstName" name="firstName"
								placeholder="Enter First Name" required>
						</div>
						<div class="input-group c">
							<label for="email"><span
								class="col-sm-2 glyphicon glyphicon-user"></span> Last Name</label> <input
