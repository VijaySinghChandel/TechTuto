...
<title>Administrator - Online Digital Photo Shop</title>
...
<body id="page-top" class="index">
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			...
			<p class="text-right">
			<kbd> Welcome ${adminUser}! ADMINSTRATOR USER</kbd>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a class="page-scroll">Welcome ${adminUser}!</a></li>
					<li><a class="page-scroll" href="#orderDetails">Order
							</a></li>
					<li><a class="page-scroll" href="#shippingDetails">Shipping
							</a></li>
					<li><a class="page-scroll" href="#userDetails">User
							</a></li>
					<li><a class="page-scroll" href="#transactionDetails">Transaction
							</a></li>
					<li><a class="page-scroll" href="#deliveredSuccessfully">Delivered
							Items</a></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
	...
	<!-- Services Section -->
	<section id="orderDetails" class="bg-light-gray">
		<div class="container">
			<div class="jumbotron">
				<h5>Order Details</h5>
	...
	<section id="shippingDetails" class="bg-darkest-gray">
	...
	<!-- About Section -->
	<section id="userDetails" class="bg-light-gray">
		<div class="container"></div>
		<div class="jumbotron">
			<h5>User Details</h5>
			<p>This part Contains order Details</p>
	...
	<!-- Team Section -->
	<section id="transactionDetails" class="bg-darkest-gray">
		<div class="container"></div>
		<div class="jumbotron">
	...
	<!-- Team Section -->
	<section id="deliveredSuccessfully" class="bg-light-gray">
		<div class="container"></div>
		<div class="jumbotron">
			<h5>Delivered Successfully Details</h5>
			<p>This part Contains order Details</p>
			<p>This part Contains order Details</p>
			<p>This part Contains order Details</p>
			<p>This part Contains order Details</p>
